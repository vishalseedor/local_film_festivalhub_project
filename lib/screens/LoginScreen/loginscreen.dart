...
class _LoginPageState extends State<LoginPage> {
  ...
  void loginLocalFilm(String phone, String password) async {
    const url = 'http://campus.sicsglobal.co.in/Project/Local_Film_Festival/api/user_login.php?';
        ...
        body: Container(
          decoration: const BoxDecoration(
              image: DecorationImage(
                  image: AssetImage('assets/bacground.jpg'), fit: BoxFit.cover)),
          child: Center(
